...
namespace ChronoFuck.Database
{
    class DatabaseService
    {
        ...
        public static SQLiteConnection DBS = new SQLiteConnection(Config.DatabasePath);
        /** Async version of connection */
        public static SQLiteAsyncConnection DB = new SQLiteAsyncConnection(Config.DatabasePath);
